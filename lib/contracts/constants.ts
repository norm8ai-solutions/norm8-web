...
export const CONTRACT_ACTIVITY_LABELS: Record<ContractActivityType, string> = {
  ...
  CONTRACT_PDF_GENERATED: 'PDF gerado',
  CONTRACT_PDF_REGENERATED: 'PDF regenerado',
  CONTRACT_REOPENED: 'Contrato reaberto',
  CONTRACT_REVISION_CREATED: 'Revisão criada',
  CONTRACT_LOCKED: 'Contrato bloqueado',
  CONTRACT_UNLOCKED: 'Contrato desbloqueado',
  CONTRACT_READY_TO_SEND: 'Pronto para envio',
